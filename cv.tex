...
My research explores interesting epidemiologic questions at the intersections
...
\item Long A, Mbabali I, Hutton HE, \textbf{Thomas AG}, Bugos E,
  ...
  Association of Providers of AIDS Care}. In Press.
...
\item Henderson M, \textbf{Thomas AG}, Massie A, Luo X, Shaffer A,
  Holscher C, Segev DL.
  ...
  Chicago, IL, USA, April 29 - May 3, 2017. Presentor: Henderson M
...
%\item Holscher C, Chow E, \textbf{Thomas AG}, Purcell C,
...
%\item Holscher C, Jackson K, \textbf{Thomas AG}, Purcell C,
...
\item \textbf{Thomas AG}, Shaffer A, Massie A, Segev DL.
...
\item Hapern SE, \textbf{Thomas AG}, Holscher CM, Massie AB,
  Henderson ML, Anjum S, Locke JE, Segev DL.
  Sexual Dysfunction Among Living Kidney Donors.
  In: \emph{American Society of Transplant Surgeons},
  Miami, FL, USA, January 26-29, 2017.

\item Long A, Hutton H, Mbabali I, \textbf{Thomas AG}, Bugos E, Mulamba J,
...
\item \textbf{Thomas AG}, Erickson J, Strickland K, Barnes A.
...
\item[] \textit{Guest Lecturer} \hfill \textbf{May 2017}
    \begin{innerlist}
        ...
        \begin{innerlist}
            ...
            \item Lecture: ``Lab: From a Dirty Dataset to Table 1''
            \item Enrollment: 281
        \end{innerlist}
    \end{innerlist}
\end{outerlist}
