...
\textbf{Healthy Aging with Chronic Disease:}
My research explores epidemiologic questions at the intersection of
vascular and cognitive aging. I hope to identify new targets for
pharmaceutical and public health interventions that can improve
the clinical care of older adults.
\vspace{2mm}
\\\textbf{Advancing Epidemiologic Methods:}
As an educator, I hope to train the next generation of public health
practitioners and researchers in causal inference and careful study design
in the context of abundant data sources not generated for research.
\vspace{2mm}
...
%\begin{outerlist}
  Total articles: 48; Total citations: 599 (2021/03/31); h-index: 13; i10-index: 15
...
\item Garg N, Warnke L, Redfield RR, Miller KM, Cooper M, Roll GR,
 ...
 Mandelbrot DA. Discrepant Subtyping of Blood Type A2 
 Living Kidney Donors: Missed Opportunities in Kidney 
 Transplantation. First Submitted 2/2021
...
\item Osbun N, \textbf{Thomas AG}, Cooper M, Flechner SM,
  Segev DL, Veale JL.
  The Benefit to Waitlist Patients in a National 
  Paired Kidney Exchange Program: Exploring 
  Characteristics of Chain End Living Donor Transplants.
  First Submitted 3/2021.
